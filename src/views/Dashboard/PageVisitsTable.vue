<template>
  <b-card body-class="p-0" header-class="border-0">
    ...
    >
      <el-table-column label="프로젝트 명" min-width="120px" prop="page">
        <template v-slot="{ row }">
          <div class="font-weight-600 project-history-name">{{ row.page }}</div>
        </template>
      </el-table-column>
      <el-table-column label="프로젝트 기간" min-width="100px" prop="period">
      </el-table-column>
      <el-table-column label="사용 기술" min-width="130px" prop="skill">
        <template v-slot="{ row }">
          <div class="project-history-skill">{{ row.skill }}</div>
        </template>
      </el-table-column>
      <el-table-column label="진행 상태" min-width="130px" prop="status">
      </el-table-column>
    </el-table>
  </b-card>
</template>
...
export default {
  ...
  data() {
    return {
      tableData: [
        {
          page: "서비스 데스크 ITSM 3.0 (사내 서비스)",
          period: "22.07 ~ 진행중",
          skill: "React.js, Typescript, Redux, Storybook etc..",
          status: "진행중",
        },
        {
          page: "핀다이렉트샵 2.0 (자사몰)",
          period: "22.01 ~ 22.06",
          skill: "Next.js, React.js, Typescript, Recoil etc..",
          status: "개발 완료, 유지보수",
        },
        {
          page: "핀다이렉트샵 1.0 (자사몰)",
