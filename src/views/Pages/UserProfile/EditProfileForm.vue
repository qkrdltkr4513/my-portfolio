    ...
    <b-row>
      <b-col>
        <div class="profile-intro justify-content-center">
          ...
          <hr class="my-4" />
          <div class="mb-4">
            <i class="ic-icons ni ni-hat-3"></i>
            <p class="title heading">학력사항</p>
            <span class="description"
              >상명대학교 컴퓨터소프트웨어공학과 졸업 (2011.03 ~ 2017.02)</span
            >
            <span class="description"
              >아산고등학교 졸업 (2008.03 ~ 2011.02)</span
            >
          </div>
          <hr class="my-4" />
          <div class="mb-4">
            <i class="ic-icons ni ni-user-run"></i
            ><span class="intro-title title heading">교내활동 및 대외활동</span>
            <!-- <span class="description">29</span> -->
            <el-table
              class="table-responsive table project-history"
              :data="activationData"
              header-row-class-name="thead-light"
            >
              <el-table-column label="활동명" min-width="90px" prop="name">
                <template v-slot="{ row }">
                  <div class="font-weight-600">{{ row.name }}</div>
                </template>
              </el-table-column>
              <el-table-column label="기간" min-width="110px" prop="period">
              </el-table-column>
              <el-table-column label="기관" min-width="100px" prop="institute">
              </el-table-column>
              <el-table-column label="내용" min-width="200px" prop="content">
              </el-table-column>
            </el-table>
          </div>
          ...
          <hr class="my-4" />
          <div class="mb-4">
            <i class="ic-icons ni ni-atom"></i
            ><span class="intro-title title heading">교육 및 스터디</span>
            <el-table
              class="table-responsive table project-history"
              :data="educationAndStudy"
              header-row-class-name="thead-light"
            >
              <el-table-column label="교육명" min-width="90px" prop="name">
                <template v-slot="{ row }">
                  <div class="font-weight-600">{{ row.name }}</div>
                </template>
              </el-table-column>
              <el-table-column label="기간" min-width="90px" prop="period">
              </el-table-column>
              <el-table-column label="구분" min-width="110px" prop="type">
              </el-table-column>
              <el-table-column label="기관" min-width="100px" prop="institute">
              </el-table-column>
              <el-table-column label="내용" min-width="200px" prop="content">
          ...
          <div class="mb-4">
            <i class="ic-icons ni ni-badge"></i>
            <p class="title heading">자격사항</p>
            <span class="description"
              >지게차운전 (한국기술자격검정원 / 2014.09)</span
            >
            <span class="description"
              >운전면허 1종 보통 (충남지방경찰청 / 2011.02)</span
            >
          </div>
        </div>
      </b-col>
